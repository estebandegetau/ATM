...
Then, take the distance between *Banco del Bienestar* and private banks in 2021:
$$
...
Finally, we can test whether the average change in distance is statistically different from zero:
$$
H_0: \mathbb E(\delta_{ij}) = 0 \quad \text{vs.} \quad H_1: \mathbb E(\delta_{ij}) \neq 0
$$

To show whether *Banco del Bienestar* is increasing geographic access to private banking.
